...
class Board
  def initialize
    @wins = { 1=>[1,2,3], 2=>[1,5,9], 3=>[1,4,7], 4=>[2,1,3], 5=>[2,5,8],
        6=>[3,1,2], 7=>[3,5,7], 8=>[3,6,9], 9=>[4,1,7], 10=>[4,5,6],
        11=>[5,2,8], 12=>[5,4,6], 13=>[5,3,7], 14=>[5,1,9], 16=>[6,3,9],
        17=>[6,5,4], 18=>[7,1,4], 19=>[7,5,3], 20=>[7,8,9], 21=>[8,2,5],
        22=>[8,7,9], 23=>[9,3,6], 24=>[9,1,5], 25=>[9,7,8] }
